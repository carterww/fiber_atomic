...
#define fiber_atomic_load(ptr, memorder) (__atomic_load_n(ptr, (int)memorder))

#define fiber_atomic_load_into(ptr, dest_ptr, memorder) \
	((void)__atomic_load(ptr, dest_ptr, (int)memorder))

#define fiber_atomic_store(ptr, val, memorder) \
	((void)__atomic_store_n(ptr, val, (int)memorder))

#define fiber_atomic_store_from(ptr, src_ptr, memorder) \
	((void)__atomic_store(ptr, src_ptr, (int)memorder))

#define fiber_atomic_exchange(ptr, val, memorder) \
	(__atomic_exchange_n(ptr, val, (int)memorder))

#define fiber_atomic_exchange_into(ptr, src_ptr, res_ptr, memorder) \
	((void)__atomic_exchange(ptr, src_ptr, res_ptr, (int)memorder))
